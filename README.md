<h1 align="center">Serhat Har</h1>

<p align="center">
  Computer Engineering Student &middot; .NET Backend &middot; Embedded Systems &middot; IoT &middot; Developer Tools
</p>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=Wezylnia&label=Profile%20views&color=0e75b6&style=flat" alt="Profile views" />
</p>
...
### [gh-actions-doctor](https://github.com/Wezylnia/gh-actions-doctor)

A lightweight .NET CLI that scans GitHub Actions workflows for security, reliability, performance, and cost issues.

### [gha-cache-doctor](https://github.com/Wezylnia/gha-cache-doctor)
...
C-based real-time spectrum and waterfall visualization project for SDR signal analysis.

### FreeRTOS Task Scheduler

Embedded C project focused on task scheduling and real-time behavior using FreeRTOS.

### HFT Order Book

C++ order book simulation focused on data structures, matching logic, and performance-oriented design.
...
Developed the official website of the Cyber Sense Laboratory at Sakarya University.
